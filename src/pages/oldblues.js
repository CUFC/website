...
export default function OldBlues({ data }) {
  return (
    <Page image={data.file.childImageSharp.fluid} seo={{title: "Old Blues"}}>
      ...
      <p>If you enjoyed your time in the club and hope that it continues to perform at the highest level, topping BUCS and smashing Oxf*rd (GDBO) then there is something you can do to help. We have recently set up a donation page that can be accessed <a href="https://www.philanthropy.cam.ac.uk/give-to-cambridge/fencing-club">here</a>.</p>
      <h2>Events</h2>
